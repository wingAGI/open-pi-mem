...
def build_prompt(
    ...
    return "".join([
        ...
        "The frames are arranged from oldest to newest and together describe the most recent planning interval.\n",
        ...
        "Workflow:\n",
        "1. At the beginning, you receive the global goal, the initial visual observation, and an empty previous memory.\n",
        "2. You internally analyze what happened during this recent frame sequence.\n",
        "3. You update memory to reflect the state at the END of this visual sequence.\n",
        "4. You output the single next subtask to execute after this sequence ends.\n",
        "5. Your next memory becomes the previous memory for the next planning step.\n",
        "Meaning of the inputs:\n",
        "- Goal: the global task objective for the whole episode.\n",
        "- Previous memory: your own memory from the PREVIOUS planning step. It represents the state before the current frame sequence. It may be incomplete or wrong.\n",
        "- History: optional textual history of earlier subtasks and outcomes. It is auxiliary context only.\n",
        "- Current frame sequence: the most recent consecutive observations, ordered from oldest to newest.\n",
        "Meaning of the outputs:\n",
        "- Subtask: the single immediate next action to execute after the current frame sequence ends.\n",
        "- Memory: a short natural-language summary of what has already been completed and what is currently in progress by the END of the current frame sequence.\n",
        ...
        "Subtask should stay atomic and should not bundle multiple repetitions or multiple stages.\n",
        "Memory should describe current confirmed progress only: what has been done and what is currently being done in this frame sequence.\n",
        "Memory should NOT restate the full task requirements or future plan.\n",
